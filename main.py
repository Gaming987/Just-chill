...
async def Krypton_stats():
    while True:
        ...
        sv_ch = client.get_channel(971076819472228372)
        users_ch = client.get_channel(973139774351224842)
...
@tree.command(
    name="embed",
    description="Create A Embed Using Laizyy"
)
...
async def on_command_completion(context: Context) -> None:
    ...
    hacker = client.get_channel(971076819472228372)
    if context.guild is not None:
        ...
        try:
            ...
            embed1.add_field(
                ...
                f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
                inline=False)
            embed1.set_footer(text="Powered By Rabbit#5069",
                              icon_url=client.user.display_avatar.url)
